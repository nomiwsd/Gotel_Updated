                            ...
                            <div className='py-3 px-3 d-flex flex-column justify-content-center align-items-center'>
                                ...
                                <div className="row m-0 p-0 smallsearchbar py-2">
                                    ...
                                    <div className="col-12 d-flex formgroup my-2 p-0">
                                        ...
                                        <input class="selectpicker form-control" placeholder='Location' onChange={(e) => { setSelectedLocation(e.target.value) }}>
                        ...
                        <div className='container py-5 px-3 landingpage'>
                            ...
                            <div className="row m-0 p-0 searchbar ">
                                ...
                                <div className="col-lg-3 col-md-6  formgroup my-1">
                                    ...
                                    <input name="jobs-location" className='searchinput' placeholder='Location' onChange={(e) => { setSelectedLocation(e.target.value) }}>
                                    </input>
                                </div>
                                <div className="col-lg-3 col-md-6  formgroup my-1">
                        ...
                        <div class="our-services row d-flex justify-contnet-center m-0 p-0 px-3">
                            <div class="col-xl-3 col-lg-3 col-md-4 col-12 my-2">
                                <div class="single-services text-center mb-30">
                                    ...
                                    <div class="services-cap">
                                        <h5><a href="#f">Design &amp; Creative</a></h5>
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-4 col-12 my-2">
                                <div class="single-services text-center mb-30">
                                    ...
                                    <div class="services-cap">
                                        <h5><a href="#fd">Design &amp; Development</a></h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-3 col-md-4 col-12 my-2">
                                <div class="single-services text-center mb-30">
                                    ...
                                    <div class="services-cap">
                                        <h5><a href="#fd">Sales &amp; Marketing</a></h5>
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-4 col-12 my-2">
                                <div class="single-services text-center mb-30">
                                    ...
                                    <div class="services-cap">
                                        <h5><a href="#fd">Construction</a></h5>
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-4 col-12 my-2">
                                <div class="single-services text-center mb-30">
                                    ...
                                    <div class="services-cap">
                                        <h5><a href="#fd">Accounting & Finance</a></h5>
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-4 col-12 my-2">
                                <div class="single-services text-center mb-30">
                                    ...
                                    <div class="services-cap">
                                        <h5><a href="#fd">Health & Hospital</a></h5>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-3 col-md-4 col-12 my-2">
                                <div class="single-services text-center mb-30">
                                    ...
                                    <div class="services-cap">
                                        <h5><a href="#fd">Content Writing</a></h5>
                                    </div>
                                </div>
                            </div>
                        </div>
