        ...
        <div className='d-flex m-0 p-0'>
            ...
            <div className="col-12 col-md-9 col-lg-10 h-100"><Navbar />
                <div id="main" class="site-main" role="main">
                    <div class="entry-my-page company-dashboard my-5 px-3">
                        ...
                        <div className="row d-flex m-4 p-0 ">
                            ...
                            <div className=" searchdiv d-flex col-12 col-lg-3  rounded-1 p-0 my-2 m-lg-0 ">
                                                            ...
                                                            <tr>
                                                                <td class="info-user">
                                                                    ...
                                                                    <div class="info-details">
                                                                        <h4 className='companyname text-center m-0'><a href="#fd">{C.companyName}</a></h4>
                                                                        <p>
                                                        ...
                                                        return (
                                                            <tr>
                                                                <td class="info-user">
                                                                    ...
                                                                    <div class="info-details">
                                                                        <h4 className='companyname text-center m-0'><a href="#d">{C.companyName}</a></h4>
                                                                        <p>
                                                                            <span>{C.categorie}</span>
                                                                        </p>
                                                                    </div>
