    ...
    return (
        <div>
            <div className='jobpostsection row d-flex m-0 p-0'>
                <div className="sidebar d-none d-md-block col-md-3 col-lg-2  m-0 p-0 h-screen">
                            ...
                            <div class="row m-0 p-0 gap-3">
                                {
                                    cources.map((cource, index) => {
                                        return (
                                            ...
                                            <div class="card col-5 p-0 m-0 coursecard" style={{ padding: '22px' }}>
                                                <img class="coursecard-img" alt="" src={cource.imageP} />
                                                <div class="card-body m-0">
                                                    ...
                                                    <div class="d-flex justify-content-end seeDetails">
                                                        <a href='#fd' className='courseheading' onClick={()=>{
