...
function Postedjob() {
    ...
    return (
        <div>
            <div className='jobpostsection  d-flex m-0 p-0'>
                <div className="d-none d-md-block col-md-3 col-lg-2 p-0 sidebar h-screen">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="action-setting jobs-control" style={{ zIndex: '1' }}>
                                                            <div class="btn-group dropend">
                                                                ...
                                                                <a class="dropdown-item" onClick={()=>{deletejob(job.id)}}>Delete</a>
                                                                </button>
                                                            </div>
                                                        </td>
                                                    </tr>
