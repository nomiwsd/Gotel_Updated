...
const Postjob = () => {
  ...
  return (
    <div><div className='jobpostsection row d-flex m-0 p-0'>
        ...
        <div className="bg-color py-2 px-2 rounded-3 col-md-12 col-lg-8 col-12 ">
            <div class="entry-title d-flex justify-content-between my-2  row m-0 p-0">
                ...
                <div className="d-flex col-12 col-md-8 col-lg-6">
                    <button className='mainbtn  '>Cancel</button>
                    <button className='mx-3 mainbtn' onClick={() => {
                        postJob()
                    }}>
                        Post Job
                    </button>
            ...
            <div className="Jobinfo row m-0 p-0 border-1" >
                <div className="col-12 p-2">
                    ...
                    <div className="d-flex flex-column form-group">
                        ...
                        <input type="text" id="jobs_title" name="jobs_title" placeholder="Name" className="inputtextfield" aria-invalid="true" value={jobTitle} onChange={(e) => { setJobTitle(e.target.value) }}></input></div>
                </div>
                <div className="col-lg-6 my-2">
                    <label className="formlabel">Jobs Categories </label>
                    <Select
                ...
                <div className="col-lg-6 my-2">
                    <label className="formlabel">Jobs Type </label>
                    <Select
                ...
                <div className="col-lg-6 my-2">
                    <label className="formlabel">Career Level </label>
                    <Select
                ...
                <div className="col-lg-6 my-2">
                    <label className="formlabel">Closing Days </label>
                    <input type="Date" className='inputtextfield' value={jobClosingDays} onChange={(e) => { setJobClosingDays(e.target.value) }} />
                </div>
            ...
            <div className="salaryinfo row m-0 p-0 my-2 border-1 py-2">
                ...
                <div className="col-lg-6 my-2 " >
                    <label className="formlabel">Maximum</label>
                    <input type="text" name="salary" className="inputtextfield" aria-invalid="true" value={jobSalaryMax} onChange={(e) => { setJobSalaryMax(e.target.value) }} />
                </div>
                <div className="col-lg-6 my-2 " >
                    <label className="formlabel">Location</label>
                    <input type="text" name="location" placeholder='Location' className="inputtextfield" aria-invalid="true" value={jobApplyType} onChange={(e) => { setJobApplyType(e.target.value) }} />
                </div>
            </div>
        </div>
